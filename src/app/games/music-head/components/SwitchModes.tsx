...
export default function SwitchModes({
  ...
  return (
    <section className="fixed top-0 left-0 z-[5000] h-screen w-full flex items-center justify-center filter bg-black/10">
      <div
        ref={ref}
        className="flex flex-col absolute z-[1100] bg-white dark:bg-[#1d2023] text-black dark:text-white font-larken items-center p-5 w-4/5 md:w-1/2 rounded-lg"
      >
        <div className="h-fit w-fit mx-auto">
          ...
          >
            <g clipPath="url(#clip0_3031_4554)">
              <path
        ...
        <form className="w-full space-y-4 font-plus-jakarta">
          <div className="relative w-full">
            ...
            <label
              htmlFor="daily-mode"
              className="block w-full text-left p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
