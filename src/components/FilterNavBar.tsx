...
export default function FilterBar({
  ...
  return (
    <>
      <div className="sticky left-0 right-0 px-7 py-4 top-[70px] md:top-[64px] z-30 w-full bg-white dark:bg-[#1d2023] md:fixed  border-b border-white/10 md:border-none">
